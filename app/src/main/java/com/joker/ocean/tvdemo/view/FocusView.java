...
public class FocusView extends  ViewGroup {
    ...
    private void initAttrs(Context context, AttributeSet attrs){
        ...
        if(mta.hasValue(R.styleable.FocusView_VisibleRow)){
            mRowsCount = mta.getInt(R.styleable.FocusView_VisibleRow, mColWidth);
        }
        if(mta.hasValue(R.styleable.FocusView_VisibleCol)){
            mColsCount = mta.getInt(R.styleable.FocusView_VisibleCol, mColWidth);
        }
        if(mta.hasValue(R.styleable.FocusView_BackgroundColor)){
            color = mta.getDrawable(R.styleable.FocusView_BackgroundColor);
        }
        if(mta.hasValue(R.styleable.FocusView_Gap)){
