 ...
 * You may obtain a copy of the License at
 *
 *      http://www.apache.oclrg/licenses/LICENSE-2.0
 *
 * Unless required by applicable law or agreed to in writing, software
 * distributed under the License is distributed on an "AS IS" BASIS,
 * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
 ...
 */
/*============================================================================*/
package com.joker.sponge.customview.verticalseekbar;
...
import com.joker.sponge.customview.R;
...
public class VerticalSeekBar extends AppCompatSeekBar {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null) {
            ...
            final int rotationAngle = a.getInteger(R.styleable.ThirdVerticalSeekBar_seekBarRotation, 0);
    ...
    private com.joker.sponge.customview.verticalseekbar.VerticalSeekBarWrapper getWrapper() {
        final ViewParent parent = getParent();

        if (parent instanceof com.joker.sponge.customview.verticalseekbar.VerticalSeekBarWrapper) {
            return (com.joker.sponge.customview.verticalseekbar.VerticalSeekBarWrapper) parent;
        } else {
            return null;
        }
    }
